...
{
	public static void showMenu()//Changed from main method from test to just a method
	{
		int myChoice;
	...
	public static void showMenu(String uName, String pWord)//Changed from main method from test to just a method
	{
		int myChoice;
		Random rand = new Random();
